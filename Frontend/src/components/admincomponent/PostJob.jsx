    ...
    <div className="min-h-screen bg-[url('/bg.jpg')] bg-cover bg-center">
      ...
      <div className="flex items-center justify-center w-screen my-5">
        <form
          ...
          className="p-8 max-w-4xl border border-black shadow-sm hover:shadow-xl hover:shadow-[#6b3ac2] rounded-lg"
        > <div><h1 className="text-center my-4 font-bold text-black">Enter Job Details Carefully</h1></div>
            ...
            <div>
              {companies.length > 0 && (
                <Select onValueChange={selectChangeHandler}>
                  ...
                  <SelectContent className="bg-[url('/bg.jpg')] bg-cover bg-center" >
                    <SelectGroup>
